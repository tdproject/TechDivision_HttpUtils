...
require_once 'TechDivision/HttpUtils/Interfaces/Response.php';

/**
 * This class is the base class for a HTTP response.
 *
 ...
 */
class TechDivision_HttpUtils_HttpResponse
	extends Zend_Controller_Response_Abstract
    implements TechDivision_HttpUtils_Interfaces_Response
{
}